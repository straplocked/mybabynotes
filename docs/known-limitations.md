...
- **The compose sheet can't add plan items**, only toggle the drafted ones off. "Add to plan" exists on a running shift (`/shifts/plan`), so an item you want that the rhythm didn't predict has to be added after taking over.
